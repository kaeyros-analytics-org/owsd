...
```r
vector_2 <- c(1,"diamond") #1 will become a character because all the elements in the vector                             are supposed to have the same type
print(vector_2)
#> [1] "1"       "diamond"
```
...
<img src="02-basics_of_r_files/figure-html/nice-fig-1.png" alt="Plot with connected points showing that vapor pressure of mercury increases exponentially as temperature increases." width="80%" />
